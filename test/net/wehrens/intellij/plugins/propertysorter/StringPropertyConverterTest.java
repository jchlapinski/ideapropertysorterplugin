...
public class StringPropertyConverterTest {
    ...
    public void testConvertString() {
        ...
        String convertString = "A=1" + StringPropertyConverter.ideaLineSeperator + "C=1" + StringPropertyConverter.ideaLineSeperator + "D=2";
    ...
    public void testConvertProperties() {
        ...
        String convertedString = stringPropertyConverter.convertSortedProperties(properties, sortedKeys);
    ...
    public void testSortStringMultipleEquals() {
        String convertString = "A=1=1" + StringPropertyConverter.ideaLineSeperator + "C=1=2" + StringPropertyConverter.ideaLineSeperator + "B=1=2";
        Properties properties = stringPropertyConverter.convertString(convertString);
    ...
    public void testNonPropertiesContent() {
        String convertString = "A=1" + StringPropertyConverter.ideaLineSeperator + "This is not a property in a line.";
        stringPropertyConverter.convertString(convertString);
    }

    @Test
    public void testConvertWithComments() {
        String convertString = "A=1" + StringPropertyConverter.ideaLineSeperator + "# Comment" + StringPropertyConverter.ideaLineSeperator + "C=1";
        Properties properties = stringPropertyConverter.convertString(convertString);
